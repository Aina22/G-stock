        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6 d-flex justify-content-end">
              <a href="lib/tools/crud/add_client.php">
          ...
          <div class="table-responsive">
            <table class="table table-secondary">
              ...
              <tbody class="overflow">
                <?php
                $sql_responsable =
                  "SELECT commande.id_commande, commande.nom_client, commande.id_produit, commande.quantites, commande.date_commande, produit.nom, produit.prix_unitaire, produit.quantiter
                  FROM commande
                ...
                while ($resultat = $request->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  $nom_clt = $resultat["nom_client"];
                  $nom_produit = $resultat["nom"];
                  $quantiter = $resultat["quantites"];
                  $prixUnitaire = $resultat["prix_unitaire"];
                  $montant = $quantiter * $prixUnitaire;
                  $date = $resultat["date_commande"];
                  ?>
                  <tr>
                    <td><?= $id_commande ?></td>
                    <td><?= $nom_clt ?></td>
                    ...
                    <td><?= $date ?></td>
                    <td>
                      <a href="lib/tools/crud/edit_client?id=<?=$id_commande?>">
                        <button class="btn btn-success">
                          <i class="fa fa-edit text-light"></i>
                        </button>
                      </a>
                      <a href="lib/tools/crud/delete_client?id=<?=$id_commande?>?>">
