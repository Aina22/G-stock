        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6 d-flex justify-content-end">
              <a href="lib/tools/crud/add_produit.php">
          ...
          <div class="table-responsive">
            <table class="table table-secondary">
              ...
              <tbody class="overflow">
                <?php
                $sql_responsable = "SELECT *,produit.nom AS Pnom,
                categorie.nom AS Cnom  FROM produit,categorie 
                ...
                while ($resultat = $request->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  <tr>
                    ...
                    <td><?= $resultat['Pnom'] ?></td>
                    <td><?= $resultat['Cnom'] ?></td>
                    <td><?= $resultat['quantiter'] ?></td>
                    <td><?= $resultat['prix_unitaire'] ?></td>
                    <td>
                      <a href="lib/tools/crud/edit_produit?id=<?= $resultat['id_produit'] ?>">
                        <button class="btn btn-success">
                          <i class="fa fa-edit text-light"></i>
                        </button>
                      </a>
                      <a href="lib/tools/crud/delete_produit?id=<?= $resultat['id_produit'] ?>">
