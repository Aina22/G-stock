<?php
session_start();
if (!isset($_SESSION['access']) && !isset($_SESSION['nom']) && !isset($_SESSION['id'])) {
        ...
        <div class="container-fluid">
          <div class="row mb-2">
            ...
            <div class="col-sm-6 d-flex justify-content-end">
              <a href="lib/tools/crud/add_responsable.php">
            ...
            <table class="table table-secondary">
              <thead>
                <tr>
                  ...
                  <th scope="col">accès admin</th>
                  <th scope="col">action</th>
                </tr>
              </thead>
              <tbody class="overflow">
                <?php
                $sql_responsable = "SELECT * FROM responsable";
                ...
                while ($resultat = $request->fetch(PDO::FETCH_ASSOC)) {
                  ...
                  ?>
                  <tr>
                    <td><?= $resultat['id_responsable'] ?></td>
                    <td><?= $resultat['nom_responsable'] ?></td>
                    <td><?= $resultat['mdp'] ?></td>
                    <td><?= $resultat['admin_access'] ?></td>
                    <td>
                      <a href="lib/tools/crud/edit_responsable?id=<?= $resultat['id_responsable'] ?>">
                        <button class="btn btn-success">
                          <i class="fa fa-edit text-light"></i>
                        </button>
                      </a>
                      <a href="lib/tools/crud/delete_responsable?id=<?= $resultat['id_responsable'] ?>">
